...
const ESCAPED_CHARS :ESCAPED_CHARS_INT = {
    '<': '\\u003C',
    '>': '\\u003E',
    '/': '\\u002F',
    '\u2028': '\\u2028',
...
function serialize(obj: any, options?: SerializeJavaScriptOptions | number | string): string {
    options || (options = {});
...
const deserialize=(data: string): any=>{
    return (new Function(`data`, `return (${data})`))(data)
}
